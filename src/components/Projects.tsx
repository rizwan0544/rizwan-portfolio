      ...
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project) => (
            <div
              key={project.name}
              className="card-hover rounded-2xl bg-white border border-border overflow-hidden flex flex-col"
            >
              <div className="relative h-44 w-full bg-lavender">
                {project.image ? (
                  <Image
                    src={project.image}
                    alt={project.name}
                  ...
                  <div className="h-full w-full flex items-center justify-center bg-gradient-to-br from-primary to-primary-dark">
